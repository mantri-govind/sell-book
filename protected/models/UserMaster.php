...
class UserMaster extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, username, password, status, last_log, role_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'comments' => array(self::HAS_MANY, 'Comment', 'user_master_id'),
			'userInfos' => array(self::HAS_MANY, 'UserInfo', 'user_master_id'),
